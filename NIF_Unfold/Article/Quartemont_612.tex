...
The kinematic base is the largest change from the initial spectrum and requires a better starting spectrum. 
	...
	\IEEEPARstart{C}{haracterizing} the energy dependent neutron environment from neutron sources has many application to the nuclear sciences community. 
...
The foils were selected based on availability and usability in the nuclear data libraries used by STAYSL. 
	...
	\ The irradiation time in the neutron pile was planned on ten days. 
This time was chosen to build up the enough activity to measure the activities. Specifically, Au-197 (n,2n) has a very long half-life, so approximately four half-lives of Au-196 were used. 
The expected activities post irradiation is summarized in Table \ref{table:active}. 
